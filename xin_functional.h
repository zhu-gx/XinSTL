...
//满足STL对抽象性的要求；满足积木性的要求；作为算法的一个参数->可配接性
//包含了XinSTL的函数对象与哈希函数
...
namespace XinSTL{
    ...
    //函数对象：加法
    template<class T>
    struct puls : public binary_function<T,T,T>{
    ...
    struct minus : public binary_function<T,T,T>{
        T opertor()(const T& x,const T& y)const{return x - y;}
    };
