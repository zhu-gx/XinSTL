...
template <class T>
struct rb_tree_iterator_base :public XinSTL::iterator<XinSTL::bidirectional_iterator_tag, T>
{
...
public:
  ...
  typedef XinSTL::allocator<base_type>              base_allocator;
...
public:
  ...
  template <class ...Args>
  XinSTL::pair<iterator, bool> emplace_unique(Args&& ...args);
  ...
  {
    return emplace_multi_use_hint(hint, XinSTL::move(value));
  }
  ...
  XinSTL::pair<iterator, bool> insert_unique(const value_type& value);
  XinSTL::pair<iterator, bool> insert_unique(value_type&& value)
  {
  ...
  {
    return emplace_unique_use_hint(hint, XinSTL::move(value));
  }
  ...
  size_type      count_multi(const key_type& key) const
  {
    ...
    return static_cast<size_type>(XinSTL::distance(p.first, p.second));
  }
  ...
  XinSTL::pair<iterator, iterator>             
  equal_range_multi(const key_type& key)
  {
    return XinSTL::pair<iterator, iterator>(lower_bound(key), upper_bound(key));
  }
  XinSTL::pair<const_iterator, const_iterator>
  equal_range_multi(const key_type& key) const
  {
    return XinSTL::pair<const_iterator, const_iterator>(lower_bound(key), upper_bound(key));
  }
  ...
  equal_range_unique(const key_type& key)
  {
    ...
    auto next = it;
    return it == end() ? XinSTL::make_pair(it, it) : XinSTL::make_pair(it, ++next);
  }
  XinSTL::pair<const_iterator, const_iterator> 
...
private:
  ...
  // get insert pos
  XinSTL::pair<base_ptr, bool> 
           get_insert_multi_pos(const key_type& key);
  XinSTL::pair<XinSTL::pair<base_ptr, bool>, bool> 
...
rb_tree<T, Compare>::
rb_tree(rb_tree&& rhs) noexcept
  :header_(XinSTL::move(rhs.header_)),
  node_count_(rhs.node_count_),
  key_comp_(rhs.key_comp_)
{
  rhs.reset();
...
emplace_multi(Args&& ...args)
{
  ...
  node_ptr np = create_node(XinSTL::forward<Args>(args)...);
...
template <class T, class Compare>
template <class ...Args>
XinSTL::pair<typename rb_tree<T, Compare>::iterator, bool> 
rb_tree<T, Compare>::
emplace_unique(Args&& ...args)
{
  ...
  if (res.second)
  { // 插入成功
    return XinSTL::make_pair(insert_node_at(res.first.first, np, res.first.second), true);
  }
  destroy_node(np);
  return XinSTL::make_pair(iterator(res.first.first), false);
}
...
insert_unique(const value_type& value)
{
  ...
  if (res.second)
  { // 插入成功
    return XinSTL::make_pair(insert_value_at(res.first.first, value, res.first.second), true);
  }
  return XinSTL::make_pair(res.first.first, false);
}
...
{
  auto p = equal_range_multi(key);
  size_type n = XinSTL::distance(p.first, p.second);
...
swap(rb_tree& rhs) noexcept
{
  if (this != &rhs)
  {
    XinSTL::swap(header_, rhs.header_);
    XinSTL::swap(node_count_, rhs.node_count_);
    XinSTL::swap(key_comp_, rhs.key_comp_);
  }
}
...
template <class T, class Compare>
XinSTL::pair<typename rb_tree<T, Compare>::base_ptr, bool>
rb_tree<T, Compare>::get_insert_multi_pos(const key_type& key)
{
  ...
  return XinSTL::make_pair(y, add_to_left);
}

// get_insert_unique_pos 函数
template <class T, class Compare>
XinSTL::pair<XinSTL::pair<typename rb_tree<T, Compare>::base_ptr, bool>, bool>
...
{ // 返回一个 pair，第一个值为一个 pair，包含插入点的父节点和一个 bool 表示是否在左边插入，
  ...
  if (add_to_left)
  {
    ...
    { // 如果树为空树或插入点在最左节点处，肯定可以插入新的节点
      return XinSTL::make_pair(XinSTL::make_pair(y, true), true);
    }
    else
  ...
  { // 表明新节点没有重复
    return XinSTL::make_pair(XinSTL::make_pair(y, add_to_left), true);
  }
  // 进行至此，表示新节点与现有节点键值重复
  return XinSTL::make_pair(XinSTL::make_pair(y, add_to_left), false);
}
...
{
  return lhs.size() == rhs.size() && XinSTL::equal(lhs.begin(), lhs.end(), rhs.begin());
}
