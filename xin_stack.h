...
#include<xin_deque.h>
//stack是在deque的基础上将底部封闭头端开口获得
//这种“修改某物接口，形成另一种风貌”的方式，也被称为adapter

//stack只有顶端的元素才可以被外界取用
//因此stack不提供走访功能，不提供迭代器
...
public:
  ...
  void swap(stack& rhs) noexcept(noexcept(XinSTL::swap(c_, rhs.c_)))
